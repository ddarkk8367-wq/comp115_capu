...
def test_remove_duplicates_set():
    ...
    assert remove_duplicates_set("aabbcc") == "abc"
    assert remove_duplicates_set("abc") == "abc"
    assert remove_duplicates_set("") == ""
    assert remove_duplicates_set("mississippi") == "misp"
...
def test_students_id():
    ...
    assert students_id(['010', '011', '012']) == 3
...
def test_students_id_occurrences():
    ...
    assert students_id_occurrences(['001', '001', '001']) == {
        '001': 3
    }
