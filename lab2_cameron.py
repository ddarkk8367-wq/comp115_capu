...
print(f"Exercise 4: The area of a circle with radies 2 is {area}")  
...
days_after_trip = (day_today + days_trip) % 7
print(f"Exercise 5: The day number after your trip will be {days_after_trip}.")
